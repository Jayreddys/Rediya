...
//bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%
    return (
        <div className="heroBanner relative  md:-top-24 h-full w-full bg-neutral-800">
                {background && (
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/4 ">
                <ContentWrapper>
                    <div className="heroBannerContent text-center flex flex-col items-center justify-center text-neutral-100">
                        ...
                        <div className="hidden w-screen md:flex items-center justify-center">
                            <div className="searchInput w-1/2 relative">
                                ...
                                />
                                <button className= " bg-gradient-to-r from-yellow-300 from-10% via-yellow-500 via-40% to-yellow-700 to-100% text-white px-4 py-2 rounded-r-full absolute right-0 top-0 h-12 w-36 hover:text-neutral-200">
                                    Search
                                </button>
                            </div>
                        </div>
